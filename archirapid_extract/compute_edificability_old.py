...
# -*- coding: utf-8 -*-
"""
Sistema profesional de validación y cálculo de edificabilidad.
Analiza documentos catastrales para determinar viabilidad de construcción.
"""
import re
...
print("=" * 80)
print("PASO 4: VALIDACIÓN Y CÁLCULO DE EDIFICABILIDAD")
print("=" * 80)

IN_DIR = Path("catastro_output")
txtf = IN_DIR / "extracted_text.txt"
ocr_txtf = IN_DIR / "ocr_text.txt"
vector_file = IN_DIR / "plot_polygon.geojson"
