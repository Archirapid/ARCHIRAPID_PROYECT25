...
def main():
    ...
    if st.session_state["client_logged_in"]:
        # Limpieza fuerte de estado de navegación al entrar en el panel
        try:
            # Limpiar query params problemáticos
            for key in ["selected_project", "selected_plot", "page"]:
                if key in st.query_params:
                    del st.query_params[key]
        except Exception:
            pass

        # Limpiar flags de navegación en session_state
        for key in ["navigate_to_client_panel", "selected_page", "auto_select_page", "selected_project_for_panel"]:
...
# TODO: función de ficha de proyecto en portal cliente desactivada. Usar show_project_detail_page en su lugar
